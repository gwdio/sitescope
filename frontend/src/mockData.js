    ...
    candidate_markets: [
        {
            ...
            next_steps: "Engage with colocation providers immediately to secure capacity. Prioritize operators with existing power allocations and established utility relationships. Verify specific substation capacity and interconnection timelines. Evaluate locations in Wilmer, Red Oak, Lancaster for newer infrastructure.",
        },
        {
            rank: 2,
            ...
            next_steps: "Investigate mega-campus developments to assess construction capacity. Prioritize providers with construction underway or near-term delivery. Leverage market's disaster recovery positioning for differentiated service offerings. Confirm CPS Energy capacity allocations for target sites.",
        },
        {
            rank: 3,
            market_name: "Houston",
            overall_viability: "strong",
            power: {
                summary: "Excellent power availability leveraging Houston's status as global energy capital. Centerpoint distribution with competitive provider choice in deregulated market. Abundant natural gas infrastructure with costs 36-47% below national average. Strong access to power generation resources. Infrastructure well-suited for data center loads with industrial heritage.",
                signal: "favorable",
            },
            community_sentiment: { summary: "", signal: "mixed" },
            tax_and_incentives: { summary: "", signal: "moderate_incentives" },
            natural_hazards: { summary: "", signal: "moderate_risk" },
            connectivity: "Strong connectivity through LOGIX Fiber Networks connecting major Texas markets, HOUIX (Houston Internet Exchange) offering free multilateral peering, and strategic position as fiber landing point to Latin America. 49 operational data centers. Functions as gateway from South Central to Southeast US. Good carrier diversity though less dense than Dallas.",
            recent_activity: "",
            key_risks: [
            ...
            next_steps: "Prioritize inland sites away from coastal flood zones. Evaluate facilities with enhanced hurricane hardening and backup power systems. Assess HOUIX peering benefits for network strategy. Consider leveraging Houston's Latin America connectivity if serving international customers.",
        },
    ],
    markets_to_avoid: [
        {
            market_name: "Austin",
            reason: "Austin must be avoided due to regulated power market creating critical constraints: (1) Power costs are 50% higher than other Texas markets due to Austin Energy monopoly, significantly impacting operational economics for power-intensive colocation; (2) Persistent power availability constraints prevent many committed projects from progressing, with highest friction score indicating infrastructure cannot keep pace with demand; (3) Regulated market structure limits competition and flexibility compared to deregulated Dallas, Houston, and San Antonio; (4) 24-month timeline is at high risk as power constraints consistently delay large-format builds. Despite Austin's strong tech ecosystem and innovation reputation (Silicon Hills, 44 data centers, 1.54 GW market value), the combination of 50% higher power costs and limited availability make it unsuitable for a 5MW facility where power is the top priority.",
        },
    ],
    methodology_note: "",
};
